...
for equipment_selection in itertools.product(
    ...
    if lowest_cost_to_beat_boss is None or lowest_cost_to_beat_boss > equipment_cost:
        if not does_player_win_fight(player_damage, player_armor):
            continue
        lowest_cost_to_beat_boss = equipment_cost

print(lowest_cost_to_beat_boss)
